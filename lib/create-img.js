...
const createImg = (_id, word, description) => {
  registerFont('public/fonts/inter/Inter-Medium.ttf', { family: 'InterMedium' });
  registerFont('public/fonts/inter/Inter-Regular.ttf', { family: 'InterRegular' });
  ...
  contextShare.drawImage(canvas, 286, 0, 628, 628);
